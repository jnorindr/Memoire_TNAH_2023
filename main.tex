...
\newacronym{iiif}{\textsc{iiif}}{International Image Interoperability Framework}
\newacronym{http}{\textsc{http}}{Hypertext Transfer Protocol}
\newacronym{https}{\textsc{https}}{Hypertext Transfer Protocol Secure}
\newacronym{uri}{\textsc{uri}}{Uniform Resource Identifier}
