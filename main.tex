...
Une chaîne de traitement automatique des sources incluant les techniques décrites dans ce mémoire, de la détection d'objet à la partition des données, permet d'envisager un traitement complet des sources historiques, depuis la numérisation d'un ouvrage jusqu'aux objets informatiques générés. Les techniques de vision artificielle mentionnées remplacent ainsi des tâches de collation et de transcription manuelles par des traitements automatiques, qui impliquent toujours des interventions des historiens pour conserver leur pertinence, 
